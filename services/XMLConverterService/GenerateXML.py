...
def generateEvent(metadata, events, outputPath):
    ...
    #ET.SubElement(destination, "uri").text = outputPath
...
def generateProfile(profileName, outputPath, outputSettings):
    """
