...
class LiveService:
    ...
    def updatePlaylist(self, path):

        resp = self.post('/live_events', path)
    ...
    def post(self, endpoint, path):
        ...
        # Set the time for session to expire. Should be ~30 seconds in the
        # future
        ...
        string1 = endpoint.encode('utf-8') + USER.encode('utf-8') + \
            APIKEY.encode('utf-8') + expiration.encode('utf-8')
        ...
        return requests.post(self.BASEURL + endpoint, headers=headers, data=body)
